...
const Projects = () => {
  ...
  return (
    <div className=" h-[50vw] bg-zinc-100 py-2 px-4 ">
      <div className="projectAnimateCont overflow-hidden bg-black w-full h-full xl:rounded-3xl  shadow-lg shadow-zinc-400  relative flex items-center justify-center gap-[28vw]">
        <video
          autoPlay="true"
          loop
          muted
          src="/src/assets/ghanta.mp4"
          className="absolute top-[35%] left-[10%] brightness-50"
        ></video>
        <div className="text-[18vw] text-white relative z-[6] font-[anzo3] leading-[14vw] tracking-wide  w-fit ">
          <h1 className="">WHAT</h1>
          <h1 className="text-zinc-400 translate-x-16">I'VE</h1>
          <h1 className="">BUILT</h1>
        </div>

        <div className="projects relative z-[5] w-[32vw] rounded-xl h-[90%] flex flex-col items-center justify-center gap-[4vw] ">
          <div className="e-commerce  w-[100%] flex-wrap flex flex-col gap-3 projectImage  items-center justify-center">
            ...
            >
              <div className=" flex items-center w-[100%]  h-[12.5vw] projectAnimate rounded-3xl overflow-hidden shadow-lg shadow-gray-700">
                <img
