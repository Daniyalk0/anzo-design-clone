...
function Page2({textClass}) {
  ...
  return (
    <div className="bg-zinc-100  text-center pt-[2vw] pb-[4vw]">
      <h2 className="font-[anzo5] text-gray-500 text-[1.3vw]">
        © dan.studio 2024 | designed and developed
      </h2>
      <div
      ...
      <div className="flex items-center justify-center scale-[0.58]">
        <svg
      ...
      <div className="w-[25%] h-[0.12vw] bg-black text-center relative left-1/2 -translate-x-1/2 mt-14"></div>
    </div>
  );
}
